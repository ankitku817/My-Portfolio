...
export default function ProjectsSection() {
    ...
    return (
        <section
            id="projects"
            className="font-sans w-full py-12 px-8 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950"
        >
            <h2 className="text-5xl sm:text-6xl font-extrabold text-center mb-6 tracking-tight leading-tight">
                🚀{" "}
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg sm:text-xl mb-8 max-w-2xl mx-auto text-center font-light">
                Here are some of my best and most recent projects that showcase my
